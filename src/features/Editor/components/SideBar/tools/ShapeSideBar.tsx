    ...
    >
      ...
      <ScrollArea>
        <div className='grid grid-cols-3 gap-4 p-4'>
          <ToolShape onClick={() => editor?.addCircle()} icon={Circle} />
          <ToolShape onClick={() => editor?.addRectangle()} icon={Square} />
          <ToolShape onClick={() => editor?.addSoftRectangle()} icon={Squircle} />
          <ToolShape onClick={() => editor?.addTriangle()} icon={Triangle} />
          <ToolShape
            onClick={() => editor?.addInverseTriangle()}
            icon={Triangle}
            iconClassName='rotate-180'
          />
          <ToolShape onClick={() => editor?.addDiamond()} icon={Diamond} />
        </div>
      </ScrollArea>
